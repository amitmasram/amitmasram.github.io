...
import AmitIcon from "@/assets/images/alog.ico";
...
export const metadata: Metadata = {
  title: "Amit Masram",
  description: "Welcome to the portfolio of Amit Masram, a passionate freelance developer creating innovative applications and websites tailored for personal, business, and startup needs. Powered by the Frontend Tribe, I specialize in delivering exceptional digital solutions that elevate user experiences. Let's connect and bring your ideas to life!",
  icons: {
